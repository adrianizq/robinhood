...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8080';
  'jhipster.clientApp.name' = 'robinnhood';
  ...
  'jhipster.mail.from' = 'robinnhood@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'robinnhood API';
  'jhipster.swagger.description' = 'robinnhood API documentation';
  ...
  'eureka.instance.appname' = 'robinnhood';
  'eureka.instance.instanceId' = 'robinnhood:${random.value}';
